function importconnectomes_basicanalysis(parcnum, thr, sparsity, varargin)
...
%% Batch Setup
% First find subject folders in the working directory
...
% Catch whether to perform thresolding of matrix    
 ...
 % Threshold the networks to desired sparsity    
    ...
    SubjStruct.thr = threshold_proportional(SubjStruct.(normtype), (sparsity./100));
        ...
        %this assumes that you intend to process the non-normalized
        %connectomes

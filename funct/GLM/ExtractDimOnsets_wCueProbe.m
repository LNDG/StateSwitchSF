function ExtractDimOnsets_wCueProbe(outputdir)
...
for s = 1:length(files)
    ...
    for i=1:nruns
        ...
        %cues and regressors
        matlabbatch{1, 1}.spm.stats.fmri_spec.sess(i).cond(5).name='CueOnset';
        matlabbatch{1, 1}.spm.stats.fmri_spec.sess(i).cond(6).name='ProbeOnset';
    ...
    for i=1:nruns
        ...
        matlabbatch{1, 1}.spm.stats.fmri_spec.sess(i).cond(5).duration=repmat(0, numel(matlabbatchold{1, 1}.spm.stats.fmri_spec.sess(i).cond(17).onset),1);
        matlabbatch{1, 1}.spm.stats.fmri_spec.sess(i).cond(6).duration=repmat(0, numel(matlabbatchold{1, 1}.spm.stats.fmri_spec.sess(i).cond(18).onset),1);

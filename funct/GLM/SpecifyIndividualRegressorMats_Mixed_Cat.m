...
for indID = 1:numel(IDs)
    ...
    matlabbatch{1}.spm.stats.fmri_spec.dir = {['/Volumes/LNDG/Projects/StateSwitch/dynamic/data/mri/task/analyses/9_Alistair/G_GLM/B_data/A_SPMfiles_Mixed_noAR_Cat/',IDs{indID}, '/']};
...
%                 lastly, find where the block ends
            ...
            if BlockDim == 1
                ...
                matlabbatch{1}.spm.stats.fmri_spec.sess(indSession).cond(1).name = ['DimBlock' '_Passive'];
                ...
                MultBlockDur=cat(1,MultBlockDur,BlockDur);
                MultBlockOnsets=cat(1,MultBlockOnsets,FirstBlockOnsets);
                
                matlabbatch{1}.spm.stats.fmri_spec.sess(indSession).cond(2).name = ['DimBlock' '_Active'];
                matlabbatch{1}.spm.stats.fmri_spec.sess(indSession).cond(2).onset = MultBlockOnsets;
                matlabbatch{1}.spm.stats.fmri_spec.sess(indSession).cond(2).duration = MultBlockDur;
    ...
    matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Dim 2-4';
    ...
    matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'Dim 1 < Dim 2-4';
    ...
    % take out now due to crummy SPM version
        ...
        matlabbatch{4}.spm.stats.results.conspec.contrasts = 3;
    ...
    save([pn.root, 'B_data/D_batchFiles1stLevelGLM-Mixed_noAR_Cat/',IDs{indID},'_SPM1stBatchGLM.mat'], 'matlabbatch')

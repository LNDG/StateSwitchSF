...
for indID = 1:numel(IDs)
    ...
    matlabbatch{1}.spm.stats.con.spmmat = {['/Volumes/lndg/Projects/StateSwitch/dynamic/data/mri/task/analyses/9_Alistair/G_GLM/B_data/tardis/B_data/SPM_Mixed/',IDs{indID}, '/SPM.mat']};

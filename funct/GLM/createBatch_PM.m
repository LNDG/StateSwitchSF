function createbatch_PM(DATADIR)
...
oID = {'2104';'2107';'2108';'2118';'2120';'2121';'2123';'2125';'2129';'2130';'2132';'2133';'2134';'2135';'2140';'2145';'2147';'2149';'2157';'2160';'2201';'2202';'2203';'2205';'2206';'2209';'2210';'2211';'2213';'2214';'2215';'2216';'2219';'2222';'2224';'2226';'2238';'2241';'2244';'2246';'2248';'2250';'2251';'2252';'2258';'2261'};

%concatentate all IDs

allIDs=cat(1,yID,oID);

matlabbatch{1}.spm.stats.factorial_design.dir = {[DATADIR '/ SPM_all_PM/']};
...
for i = 1:length(allIDs)
    ...
    subjID=allIDs(i);
    scans(i,1)={fullfile(DATADIR, subjID{1}, 'con_0002.nii,1')};
...
mkdir([DATADIR '/' 'SPM_all_PM']);
save([DATADIR '/' 'SPM_all_PM' '/' 'SPM2ndBatchGroupLoadFGLM.mat'], 'matlabbatch');
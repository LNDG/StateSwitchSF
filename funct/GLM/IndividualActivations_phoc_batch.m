function IndividualActivations_phoc_batch
...
for indID = 1:numel(IDs)
    ...
    matlabbatch{1}.spm.stats.con.spmmat = {['/Volumes/lndg/Projects/StateSwitch/dynamic/data/mri/task/analyses/9_Alistair/G_GLM/B_data/tardis/B_data/v7219/SPM_wcueprobe_3Cue/' IDs{indID} '/' 'SPM.mat']};
    ...
    matlabbatch{2}.spm.stats.results.spmmat = cfg_dep('fMRI Results Report: SPM.mat File', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
    matlabbatch{2}.spm.stats.results.conspec.titlestr = '';
    matlabbatch{2}.spm.stats.results.conspec.contrasts = 5;

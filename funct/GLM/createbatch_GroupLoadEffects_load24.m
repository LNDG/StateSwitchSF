function createbatch_GroupLoadEffects_load24(DATADIR)
...
matlabbatch{1}.spm.stats.factorial_design.dir = {[DATADIR '/SPM_all_load24/']};
...
subjID=yID(i);    
matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(i).scans = {fullfile(DATADIR, subjID{1}, 'con_0002.nii,1');
...
subjID=oID(i);    
matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(curridx+i).scans = {fullfile(DATADIR, subjID{1}, 'con_0002.nii,1');
                                                                                    fullfile(DATADIR, subjID{1}, 'con_0003.nii,1');
                                                                                    fullfile(DATADIR, subjID{1}, 'con_0004.nii,1');
                                                                                    };
matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(curridx+i).conds = [2 2 2
                                                                                          1 2 3];
...
mkdir([DATADIR '/' 'SPM_all_load24']);
save([DATADIR '/' 'SPM_all_load24' '/' 'SPM2ndBatchGroupLoadFGLM.mat'], 'matlabbatch');

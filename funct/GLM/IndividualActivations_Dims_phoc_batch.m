function IndividualActivations_Dims_phoc_batch
...
for indID = 1:numel(IDs)
    ...
    matlabbatch{1}.spm.stats.results.spmmat = {['/Volumes/lndg/Projects/StateSwitch/dynamic/data/mri/task/analyses/9_Alistair/G_GLM/B_data/tardis/B_data/v7219/SPM_Mixed_noAR/' IDs{indID} '/' 'SPM.mat']};

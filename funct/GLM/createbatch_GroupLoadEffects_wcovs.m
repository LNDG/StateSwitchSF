function createbatch_GroupLoadEffects_wcovs(DATADIR, covnames, covs)
...
matlabbatch{1}.spm.stats.factorial_design.dir = {[DATADIR '/ SPM_all_wcovs/']};
...
%%Add in covariates - can add in for multiple later
matlabbatch{1}.spm.stats.factorial_design.cov(1).c = covs;
matlabbatch{1}.spm.stats.factorial_design.cov(1).cname = covnames;
...
mkdir([DATADIR '/' 'SPM_all_wcovs']);
save([DATADIR '/' 'SPM_all_wcovs' '/' 'SPM2ndBatchGroupLoadFGLM.mat'], 'matlabbatch');

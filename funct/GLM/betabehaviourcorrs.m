...
for j = 1:nclusters
    ...
    plot(SPM.marsY.Y(length(yID)+1:92,j),Acc_dimmean(length(yID)+1:92,1),'Marker','o','MarkerSize',8,'LineStyle','none','MarkerEdgeColor','red','MarkerFaceColor','red')
...
for j = 1:nclusters
    ...
    plot(SPM.marsY.Y(length(yID)+1:92,j),RTs_dimmean(length(yID)+1:92,1),'Marker','o','MarkerSize',8,'LineStyle','none','MarkerEdgeColor','red','MarkerFaceColor','red')

    
    %young only
    
    figure(6),subplot(3,2,j)
...
for j = 1:nclusters
    ...
    plot(SPM.marsY.Y(length(yID)+1:92,j),mean(Acc_dimmean(length(yID)+1:92,2:4),2),'Marker','o','MarkerSize',8,'LineStyle','none','MarkerEdgeColor','red','MarkerFaceColor','red')

    
    %young only
    
    figure(9),subplot(3,2,j)
...
for j = 1:nclusters
    ...
    plot(SPM.marsY.Y(length(yID)+1:92,j),mean(RTs_dimmean(length(yID)+1:92,2:4),2),'Marker','o','MarkerSize',8,'LineStyle','none','MarkerEdgeColor','red','MarkerFaceColor','red')

    
    %young only
    
    figure(12),subplot(3,2,j)

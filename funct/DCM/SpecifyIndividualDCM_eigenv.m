function SpecifyIndividualDCM_eigenv(DATADIR, OUTBATCHDIR, sigclustcoords, sigclustnames)
...
for indID = 1:numel(allIDs)
    ...
    % adjust for effects of interest: F contrast covering 3cond and their
    % derivatives
    matlabbatch{iRoi}.spm.util.voi.adjust = 2; 
    matlabbatch{iRoi}.spm.util.voi.session = indSession;
    matlabbatch{iRoi}.spm.util.voi.name = sigclustnames{iRoi};
    matlabbatch{iRoi}.spm.util.voi.roi{1}.sphere.centre = centers{iRoi};
    matlabbatch{iRoi}.spm.util.voi.roi{1}.sphere.radius = 4;
    matlabbatch{iRoi}.spm.util.voi.roi{1}.sphere.move.fixed = 1;
    matlabbatch{iRoi}.spm.util.voi.expression = 'i1';
    ...
    %SPM MAT file
    matlabbatch{1}.spm.stats.fmri_spec.dir = {[DATADIR '/' IDs{indID} '/SPM.mat']};

               end
    
    save([pn.root, 'B_data/D_batchFiles1stLevelGLM-', OUTBATCHDIR,'-tardis/',IDs{indID},'_run-', indSession,'_SPMeigentsDCM.mat'], 'matlabbatch');
